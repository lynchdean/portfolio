          ...
          <div className="container mx-auto pb-8">
              <SectionHeading heading="Projects:" />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <ProjectCard title="pizzapool" github="lynchdean/pizzapool" desc={["A carpool-style group ordering web app.", "Used by one of the most popular run clubs in Dublin."]} tech={["Python", "Django"]}/>
                    <ProjectCard title="Mild Watch Face" github="lynchdean/MildWatchFace " desc={["Garmin watch face for Mild Activity Run CLub"]} tech={["MonkeyC"]} />
                    <ProjectCard title="Dean's Simple Watch Face" github="lynchdean/DeansSimpleWatchFace" desc={["A simple data-rich watch face for Garmin devices."]} tech={["MonkeyC"]} />
                    <ProjectCard title="Portfolio" github="lynchdean/portfolio" desc={["Personal portfolio website (you are here)"]} tech={["React", "Next.js", "Tailwind CSS"]} />
                    <ProjectCard title="BirdWatch Fingal" github="lynchdean/birdwatch-fingal" desc={["Website for BirdWatchIreland Fingal branch."]} tech={["React", "Bootstrap"]} />
                </div>
          </div>
      </div>
  );
